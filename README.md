...
*   **Credential Support provided by [Stash](https://stash.wiki/)**
    *   Special thanks to Stash for providing credential support, enabling continuous updates for this personal rule set.
    *   特别感谢 Stash 提供凭证支持，使本仓库的自用规则得以保持更新。

## ☕ Support Levi / 支持作者

Your support keeps the projects alive! / 您的支持是项目维护的动力！
